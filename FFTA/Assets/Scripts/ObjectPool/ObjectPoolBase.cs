...
namespace AquilaFramework.ObjectPool
{
    ...
    public abstract class ObjectPoolBaseTest<T> : IObjectPool where T : IObject,new()
    {
        //public delegate void PoolHandler (T obj);
        //public Action<T> PoolHandler;
        /// <summary>
        /// 对象池存储器
        /// </summary>
        private Queue<IObject> _pool;

        /// <summary>
        /// 保存对象回收状态的map，如果对象被获取，则标记为false，在池中为true
        /// </summary>
        private Dictionary<IObject, bool> _objectMap;
        ...
        public void Create ()
        {
            ...
            _pool = new Queue<IObject>( DEFAULT_CAPACITY );
            _objectMap = new Dictionary<IObject, bool>( DEFAULT_CAPACITY );
        }
        ...
        /// 设置对象的引用状态
        /// </summary>
        protected void SetObjectReferenceState<W>(W obj, bool useState) where W :class,IObject
        {
            if (obj is null)
                throw new AquilaException( "SetObjectRefereceState ---> obj is null" );
        ...
        /// 删除对象引用
        /// </summary>
        protected void DeleteObjectReference<W> (W obj) where W :class, IObject
        {
            if (obj is null)
                throw new AquilaException( "DeleteObjectReference ---> obj is null" );
        ...
        /// 增加对象引用
        /// </summary>
        protected void AddObjectReference<W> (W obj, bool defaultState = false) where W : class, IObject
        {
            if (obj is null)
                throw new AquilaException( "AddObjectReference ---> obj is null" );
